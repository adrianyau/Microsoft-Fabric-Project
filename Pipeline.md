...
4. Under 'Source', select 'Connection' for the Lakehouse created previously (MavenMarket_Lakehouse).  For 'File path', browse to select the CSV file respective to the 'copy data' activity.
